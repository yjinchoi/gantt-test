...
let tasks = {
    data: [
        ...
        },
        {
            ...
            progress: 0.5,
            owner: [
                { resource_id: "10", value: 4 },
                { resource_id: "9", value: 5 },
            ],
            test: "테스트8",
            priority: 1,
        },
...
function App() {
    return (
        <div style={rootStyle}>
            <Gantt id="gantt_here" tasks={tasks} resources={resources} style={{ width: "100%", height: "100%" }} />
        </div>
    );
}
